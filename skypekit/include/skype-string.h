...
//protected:
        ...
        explicit SEString(unsigned int buf);
...
public:
         ...
         */
        SEString substr(int s_from) const
        {
            return substr(s_from, length() - 1);
        }
        ...
        */
        ...
        /** Finds the first occurence of the provided string.
         * \return  Returns the position of the start of str or -1 if str could not be found.
        */
        int find(const SEString& str) const
        {
            return find(0, str);
        }
        int find(int startpos, const SEString& str) const;
        /** Url-decodes the string
         * \return  Returns a url-decoded version of the string
        */
        SEString urlDecode() const;
        ...
        /** Converts the string to a boolean. Works like atoi; "true" will 
         * yield false, as will any other non-decimal string.
        ...
        SEString& vFormat(const char *format, va_list arglist);
        SEString& Format(const char *format, ...) {
                va_list args;
...
public:
        ...
        static const SEString from(const char *bin, unsigned int len);
        static const SEString from(unsigned char chr);
        static const SEString from(char chr)
        {
            return from((unsigned char)chr);
        }
