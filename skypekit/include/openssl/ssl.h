...
// Skype patch for linking with QikLib
#if defined(QIKLIB) || !defined(NO_FILESYSTEM)
...
// Skype patch for linking with QikLib
#if defined(QIKLIB) || defined(NO_FILESYSTEM) || defined(MICRIUM)
...
#endif /* QIKLIB || NO_FILESYSTEM || MICRIUM */
